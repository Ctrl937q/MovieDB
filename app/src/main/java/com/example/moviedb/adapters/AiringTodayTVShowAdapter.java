...
public class AiringTodayTVShowAdapter extends RecyclerView.Adapter<AiringTodayTVShowAdapter.Holder> {
    ...
    public AiringTodayTVShowAdapter(Context context, List<TVResult> movies) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!TestInternetConnection.checkConnection(context)) {
                        ...
                        Call<TVResponse> call = ApiClient.getClient().getAiringTodayTVShow(pageNumber, Const.API_KEY);
                        pageNumber++;
