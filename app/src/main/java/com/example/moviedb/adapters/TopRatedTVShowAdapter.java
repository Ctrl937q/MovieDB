...
public class TopRatedTVShowAdapter extends RecyclerView.Adapter<TopRatedTVShowAdapter.Holder> {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!TestInternetConnection.checkConnection(context)) {
                        ...
                        Call<TVResponse> call = ApiClient.getClient().getTopRatedTVShow(pageNumber, Const.API_KEY);
                        pageNumber++;
