...
public class OnTheAirTVShowAdapter extends RecyclerView.Adapter<OnTheAirTVShowAdapter.Holder> {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!TestInternetConnection.checkConnection(context)) {
                        ...
                        Call<TVResponse> call = ApiClient.getClient().getOnTheAirTVShow(pageNumber, Const.API_KEY);
                        pageNumber++;
