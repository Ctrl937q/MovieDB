...
public class FragmentCastBiography extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        final View rootView = inflater.inflate(R.layout.tab_cast_biography, container, false);
        textViewBiography = (TextView)rootView.findViewById(R.id.text_view_biography);
